...
namespace MarkConv.Tests
{
    public class HtmlElementTests : TestsBase
    {
        ...
        public void ShouldReportHtmlParseErrors()
        {
            ...
            Assert.Equal("Parse error: extraneous input '/' expecting {'area', 'base', 'br', 'col', 'embed', 'hr', 'img', 'input', 'link', 'meta', 'param', 'source', 'track', 'wbr', 'cut', 'linkmap', 'include', TAG_NAME} at [9,2..3)", messages[2]);
